...
func (privKey *PrivKey) PubKey() crypto2.PubKey {
...
func (privKey *PrivKey) Equals(other crypto2.LedgerPrivKey) bool {
...
func (pubKey *PubKey) Equals(other crypto2.PubKey) bool {
